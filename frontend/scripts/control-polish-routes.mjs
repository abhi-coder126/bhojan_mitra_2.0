...
const origin = process.env.UI_AUDIT_ORIGIN || "http://127.0.0.1:5178";
...
const routes = ['/', '/restaurant-orders', '/order-management', '/menu-items', '/all-products', '/purchase', '/grn-management', '/supplier-bills', '/sales-return', '/invoices', '/customers', '/vendors', '/accounts', '/coupons', '/rewards', '/settings', '/table-barcodes', '/tables', '/kds', '/smart-inventory', '/audit-logs', '/royalty', '/support', '/login', '/menu/1', '/menu/delivery', '/menu/AUDIT/1', '/branches'];
...
try {
 ...
 fs.writeFileSync('control-polish-routes.json',JSON.stringify({results,issues},null,2));
